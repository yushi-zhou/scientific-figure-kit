  ...
  render: (params, theme) => {
    return (
      <svg width={800} height={500} viewBox="0 0 800 500" xmlns="http://www.w3.org/2000/svg">
        ...
        <CurvedArrow groupId="curve-8"  start={{x: 140, y: 200}} end={{x: 310, y: 130}} controlPoint={{x: 225, y: 150}} color={theme.colors.primary} />
        <CurvedArrow groupId="curve-9"  start={{x: 490, y: 130}} end={{x: 660, y: 200}} controlPoint={{x: 575, y: 150}} color={theme.colors.primary} />
        <CurvedArrow groupId="curve-10"  start={{x: 660, y: 260}} end={{x: 530, y: 350}} controlPoint={{x: 595, y: 305}} color={theme.colors.secondary} />
        <CurvedArrow groupId="curve-11"  start={{x: 440, y: 380}} end={{x: 360, y: 380}} controlPoint={{x: 400, y: 380}} color={theme.colors.accent} />
        <CurvedArrow groupId="curve-12"  start={{x: 180, y: 380}} end={{x: 140, y: 260}} controlPoint={{x: 160, y: 320}} color={theme.colors.accent} label="Feedback loop" />
