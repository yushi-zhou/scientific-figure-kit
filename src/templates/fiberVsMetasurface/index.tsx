  ...
  render: (params, theme) => {
    return (
      <svg width="800" height="500" viewBox="0 0 800 500" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Panel A */}
        <g id="panel_A">
          <PanelFrame groupId="layer_frame_A" x="20" y="60" width="370" height="420" title={params.leftTitle} panelLabel={params.showPanelLetters ? "A" : ""} theme={theme} />
          ...
          <TextLabel x="205" y="440" text={params.leftProblem1} anchor="middle" color={theme.colors.warning} />
        </g>

        {/* Panel B */}
        <g id="panel_B">
          <PanelFrame groupId="layer_frame_B" x="410" y="60" width="370" height="420" title={params.rightTitle} panelLabel={params.showPanelLetters ? "B" : ""} theme={theme} />
          ...
          <TextLabel x="595" y="440" text={params.rightBenefit2} anchor="middle" color={theme.colors.accent} />
        </g>
      </svg>
    );
  }
