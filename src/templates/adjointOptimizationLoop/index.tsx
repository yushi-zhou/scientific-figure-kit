  ...
  render: (params, theme) => {
    return (
      <svg width="700" height="600" viewBox="0 0 700 600" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Connections */}
        <CurvedArrow start={{x: 450, y: 130}} end={{x: 550, y: 200}} controlPoint={{x: 550, y: 130}} color={theme.colors.primary} />
        <CurvedArrow start={{x: 550, y: 260}} end={{x: 550, y: 400}} controlPoint={{x: 550, y: 330}} color={theme.colors.primary} />
        
        <CurvedArrow start={{x: 450, y: 430}} end={{x: 250, y: 430}} controlPoint={{x: 350, y: 430}} label={params.objectiveLabel} color={theme.colors.secondary} />
        <CurvedArrow start={{x: 150, y: 400}} end={{x: 150, y: 260}} controlPoint={{x: 150, y: 330}} color={theme.colors.secondary} />
        
        <CurvedArrow start={{x: 150, y: 200}} end={{x: 250, y: 130}} controlPoint={{x: 150, y: 130}} color={theme.colors.secondary} />

        <CurvedArrow start={{x: 250, y: 230}} end={{x: 350, y: 300}} controlPoint={{x: 300, y: 230}} color={theme.colors.accent} />
        <CurvedArrow start={{x: 350, y: 360}} end={{x: 350, y: 160}} controlPoint={{x: 350, y: 260}} color={theme.colors.accent} />
